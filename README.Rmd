...
{cicalc} contains a number of common confidence intervals commonly used in the pharma industry. For a full list of avialiable methods see the [package index](https://gsk-biostatistics.github.io/cicalc/reference/index.html)
